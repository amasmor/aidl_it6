...
def main(opt, unet_version, ds_version, data_augmentation, inverted_freq):
    ...
    experiment_id =  opt + '.' + unet_version + '.' + ds_version
...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', '--network', default='linear', help='UNet version (with/out concatenations)')
    parser.add_argument('-ds', '--dataset', default='cityscapes', help='cityscapes full dataset, it6 skim version')
    parser.add_argument('-da', '--data_augmentation', default='n', help='Apply data augmentation, random vertical flip and brightness')
    parser.add_argument('-invf', '--inverted_freq', default='n', help='Apply inverted frequency to the criterion')
    args = parser.parse_args()
    print('{}, {}, {}, {}, {}'.format(args.optimizer, args.network, args.dataset, args.data_augmentation, args.inverted_freq))

    main(opt= args.optimizer, unet_version=args.network, ds_version=args.dataset, data_augmentation=args.data_augmentation, inverted_freq=args.inverted_freq)
